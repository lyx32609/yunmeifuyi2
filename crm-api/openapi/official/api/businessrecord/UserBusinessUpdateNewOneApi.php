 ...
 * @author lzk
 */
class UserBusinessUpdateNewOneApi extends Api
{
    public function run()
    {
        ...
        $res = $service->userBusinessUpdateNewOne($business_id,$customer_state,$customer_priority,$customer_longitude,$customer_latitude,$customer_photo_str,$followup_text, $user_longitude, $user_latitude, $is_cooperation);
        if(!$res)
        {
