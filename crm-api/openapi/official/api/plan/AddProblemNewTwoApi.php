...
class AddProblemNewTwoApi extends Api
{
	/**
	 * 提交问题接口
	 * 
	...
	public function run()
	{
		...
		$result = $service->addProblemNew($user_id, $user_name,$problem_title, $problem_content, $priority, $collaboration_department, $appkey, $appid, $masterSecret);
		if($result === false)
        {
