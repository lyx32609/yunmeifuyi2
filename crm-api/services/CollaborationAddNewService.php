...
class CollaborationAddNewService extends Service
{
	/**
	 * 协同补充
	 ...
	 */
	public function questionAdd($problem_id, $user_id, $user_name, $collaboration_content, $appkey, $appid, $masterSecret)
	{
