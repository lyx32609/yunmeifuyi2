...
class Shop extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['shop_name', 'name', 'phone', 'shop_type', 'shop_source', 'shop_status', 'shop_priority', 'shop_longitude', 'user_name', 'user_id', 'company_category_id', 'shop_review', 'shop_addr', 'shop_domain', 'createtime', 'shop_title', 'shop_describe'], 'required'],
            ...
            [['shop_name', 'name', 'shop_longitude', 'user_name', 'shop_addr', 'shop_title', 'shop_describe'], 'string', 'max' => 255],
            [['phone'], 'string', 'max' => 11]
        ];
    }
