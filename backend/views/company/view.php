...
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Company Categroys'), 'url' => ['index']];
...
<?php 
                ...
                if($model->fly != 0){$fly_data = CompanyCategroy::find()->where(["fly"=>$model->fly])->one();$fly = $fly_data['name'];}
