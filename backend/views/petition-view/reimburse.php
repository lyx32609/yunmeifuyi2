    ...
    <div class="content">
        ...
        <table class="tg" style="table-layout:fixed;">
            <tr>
                ...
                <td class="tg-s6z2" colspan="13" name="typePetition">报销</td>
                <td class="tg-s6z2" colspan="3">提报日期</td>
                <td class="tg-s6z2" colspan="11" name="create_time"><?php echo $detail['create_time']?></td>
            </tr>
            <tr>
                <td class="tg-s6z2" colspan="3">标题</td>
                <td class="tg-yw4l" colspan="16" name="title"><?php echo $message->title;?></td>
                <td class="tg-s6z2" colspan="3">金额</td>
                <td class="tg-s6z2" colspan="8" name="money"><?php echo $message->money;?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="tg-031e" colspan="27" name="content"><?php echo $message->content;?></td>
            </tr>
