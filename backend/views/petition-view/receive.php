...
<body>
        ...
        $meg = explode(';', $message->message);//领用物品
        $list1 = $data['list1'];//加签
        $list = $data['list'];//审批
    ...
    <div class="content">
        ...
        <table class="tg" style="table-layout:fixed;">
            <tr>
                ...
                <td class="tg-s6z2" colspan="13" name="typePetition">领用</td>
            ...
            <tr>
                <td class="tg-s6z2" colspan="3">原因</td>
                <td class="tg-yw4l" colspan="27" name="reason"><?php echo $message->reason;?></td>
            </tr>
            <?php foreach($meg as $v){
                $m = explode(",",$v);
                ?>
                <tr>
                    <td class='tg-s6z2' colspan='3'>名称</td>
                    <td class='tg-s6z2' colspan='13' name='title'><?php echo $m[0]?></td>
                    <td class='tg-s6z2' colspan='3'>数量</td>
                    <td class='tg-s6z2' colspan='11' name='count'><?php echo $m[1]?></td>
                </tr>
            <?php }?>
