    ...
    <div class="content">
        ...
        <table class="tg" style="table-layout:fixed;">
            <tr>
                ...
                <td class="tg-s6z2" colspan="13" name="typePetition">离职</td>
            ...
            <tr>
                ...
                <td class="tg-s6z2" colspan="4">拟离职日期</td>
                <td class="tg-s6z2" colspan="10" name="plandimissiondate"><?php echo $message->plandimissiondate;?></td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="tg-s6z2" colspan="3">离职原因</td>
                <td class="tg-031e" colspan="27" name="dimissionreason"><?php echo $message->dimissionreason;?></td>
            </tr>
