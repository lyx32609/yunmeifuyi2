    ...
    <div class="content">
        ...
        <table class="tg" style="table-layout:fixed;">
            <tr>
                ...
                <td class="tg-s6z2" colspan="13" name="typePetition">加班</td>
                <td class="tg-s6z2" colspan="3">提报日期</td>
                <td class="tg-s6z2" colspan="11" name="create_time"><?php echo $detail['create_time']?></td>
            </tr>
            <tr>
                <td class="tg-s6z2" colspan="3">时长</td>
                <td class="tg-s6z2" colspan="13" name="duration"><?php echo $message->duration;?></td>
                <td class="tg-s6z2" colspan="3">加班日期</td>
            ...
            <tr>
                <td class="tg-s6z2" colspan="3">事由</td>
                <td class="tg-031e" colspan="27" name="origin"><?php echo $message->origin;?></td>
            </tr>
