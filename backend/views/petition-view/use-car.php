    ...
    <div class="content">
        ...
        <table class="tg" style="table-layout:fixed;">
            <tr>
                ...
                <td class="tg-s6z2" colspan="13" name="typePetition">用车</td>
                <td class="tg-s6z2" colspan="3">提报日期</td>
                <td class="tg-s6z2" colspan="11" name="create_time"><?php echo $detail['create_time']?></td>
            </tr>
            <tr>
                <td class="tg-s6z2" colspan="3">车型</td>
                <td class="tg-s6z2" colspan="13" name="carmodel"><?php echo $message->carmodel;?></td>
                <td class="tg-s6z2" colspan="3">用车数量</td>
                <td class="tg-s6z2" colspan="11" name="number"><?php echo $message->number;?></td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="tg-s6z2" colspan="3">目的地</td>
                <td class="tg-s6z2" colspan="13" name="termini"><?php echo $message->termini;?></td>
                <td class="tg-s6z2" colspan="3">用车日期</td>
                <td class="tg-s6z2" colspan="11" name="date"><?php echo $message->date;?></td>
            </tr>
