    ...
    <div class="content">
        ...
        <table class="tg" style="table-layout:fixed;">
            <tr>
                ...
                <td class="tg-s6z2" colspan="13" name="typePetition">转正</td>
                <td class="tg-s6z2" colspan="3">提报日期</td>
                <td class="tg-s6z2" colspan="11" name="create_time"><?php echo $detail['create_time']?></td>
            </tr>
            <tr>
                <td class="tg-s6z2" colspan="3">入职日期</td>
                <td class="tg-s6z2" colspan="13" name="entrydate"><?php echo $message->entrydate;?></td>
                <td class="tg-s6z2" colspan="4">拟转正日期</td>
                <td class="tg-s6z2" colspan="10" name="regularworkerdate"><?php echo $message->regularworkerdate;?></td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="tg-s6z2" colspan="3">转正原因</td>
                <td class="tg-031e" colspan="27" name="regularworkerreason"><?php echo $message->regularworkerreason;?></td>
            </tr>
