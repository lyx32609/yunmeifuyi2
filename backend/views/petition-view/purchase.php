    ...
    <div class="content">
        ...
        <table class="tg" style="table-layout:fixed;">
            <tr>
                ...
                <td class="tg-s6z2" colspan="13" name="typePetition">采购</td>
                <td class="tg-s6z2" colspan="3">提报日期</td>
                <td class="tg-s6z2" colspan="11" name="create_time"><?php echo $detail['create_time']?></td>
            </tr>
            <tr>
                <td class="tg-s6z2" colspan="3">物品</td>
                <td class="tg-s6z2" colspan="13" name="goods"><?php echo $message->goods;?></td>
            ...
            <tr>
                <td class="tg-s6z2" colspan="3">详情</td>
                <td class="tg-031e" colspan="27" name="details"><?php echo $message->details;?></td>
            </tr>
