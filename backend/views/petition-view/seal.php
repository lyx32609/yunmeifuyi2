...
<body>
    <?php 
        ...
        $meg = explode(';', $message->message);//用印
        $list1 = $data['list1'];//加签
        $list = $data['list'];//审批
    ?>
<div class="wrap">
    <div class="content">
        ...
        <table class="tg" style="table-layout:fixed;">
            <tr>
                ...
                <td class="tg-s6z2" colspan="13" name="typePetition">用印</td>
                <td class="tg-s6z2" colspan="3">提报日期</td>
                <td class="tg-s6z2" colspan="11" name="create_time"><?php echo $detail['create_time']?></td>
            </tr>
            <tr>
                <td class="tg-s6z2" colspan="3">印章用途</td>
                <td class="tg-yw4l" colspan="27" name="title"><?php echo $message->title;?></td>
            </tr>
            <tr>
            ...
            <?php foreach($meg as $v){
                $m = explode(",",$v);
                ?>
                <tr>
                    <td class='tg-s6z2' colspan='3'>用印文件名称</td>
                    <td class='tg-s6z2' colspan='9' name='title'><?php echo $m[1]?></td>
                    <td class='tg-s6z2' colspan='3'>用印次数</td>
                    <td class='tg-s6z2' colspan='5' name='count'><?php echo $m[2]?></td>
                    <td class='tg-s6z2' colspan='3'>印章名称</td>
                    <td class='tg-s6z2' colspan='7' name='count'><?php echo $m[0]?></td>
                </tr>
