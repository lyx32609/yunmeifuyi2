    ...
    <div class="content">
        ...
        <table class="tg" style="table-layout:fixed;">
            <tr>
                ...
                <td class="tg-s6z2" colspan="13" name="typePetition">用证</td>
                <td class="tg-s6z2" colspan="3">日期</td>
                <td class="tg-s6z2" colspan="11" name="create_time"><?php echo $detail['create_time']?></td>
            </tr>
            <tr>
                <td class="tg-s6z2" colspan="3">证件名称</td>
                <td class="tg-s6z2" colspan="13" name="name"><?php echo $message->name;?></td>
                <td class="tg-s6z2" colspan="3">类型</td>
                <td class="tg-031e creditype" colspan="11">
                    <input type="hidden" ><img src="<?php if(stristr($message->flag,'0') !== false){?>/images/checked.png<?php }else{?>/images/checkedNo.png<?php }?>"/><label for="">原件</label>
                    <input type="hidden" ><img src="<?php if(stristr($message->flag,'1') !== false){?>/images/checked.png<?php }else{?>/images/checkedNo.png<?php }?>"/><label for="">复印件</label>
                    <input type="hidden" ><img src="<?php if(stristr($message->flag,'2') !== false){?>/images/checked.png<?php }else{?>/images/checkedNo.png<?php }?>"/><label for="">扫描件</label>
                </td>
            </tr>0
            <tr>
            ...
            <tr>
                ...
                <td class="tg-031e" colspan="27" name="purpose"><?php echo $message->purpose;?></td>
            </tr>
