...
<div class="petition-create">
    ...
    <form action="/petition/create" id="signForm" enctype="multipart/form-data" method="post">
        ...
        <div class="cont">
            <div class="cont_tit" style="width:100%;"><h5>转正签呈</h5></div>
            <input type="hidden" name="type" value="12">
            <input name="_csrf-backend" type="hidden" id="_csrf" value="<?= Yii::$app->request->csrfToken?>">
            <dl>
                <dd><label for="entrydate"><span>*</span>入职日期：</label><input id="entrydate" type="text" name="message[entrydate]"></dd>
                <dd><label for="regularworkerreason"><span>*</span>转正原因：</label><textarea id="regularworkerreason" name="message[regularworkerreason]"></textarea></dd>
                <dd><label for="regularworkerdate"><span>*</span>拟转正日期：</label><input id="regularworkerdate" type="text" name="message[regularworkerdate]"></dd>
...
<script>
    $(function(){
        ...
        $('#regularworkerdate').datepicker(); //拟转正日期
    });

    $("#entrydate").change(dateChange);
    $("#regularworkerdate").change(dateChange);
    function dateChange(){
        if($(this).val()!=''){
    ...
    $(function(){
        $("#signForm").validate({
            ...
            rules:{
                ...
                "message[regularworkerreason]":"required",
                "message[regularworkerdate]":{
                    "required":true,
                    "dateISO":true
                },
                approver_id:{
