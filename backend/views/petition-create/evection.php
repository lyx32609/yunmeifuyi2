...
<div class="petition-create">
    ...
    <form action="/petition/create" id="signForm" enctype="multipart/form-data" method="post">
        ...
        <div class="cont">
            <div class="cont_tit" style="width:100%;"><h5>出差签呈</h5></div>
            <input type="hidden" name="type" value="8">
            <input name="_csrf-backend" type="hidden" id="_csrf" value="<?= Yii::$app->request->csrfToken?>">
            <dl>
                <dd><label for="site"><span>*</span>地点：</label><input id="site" type="text" name="message[site]"></dd>
                <dd><label for="reason"><span>*</span>事由：</label><textarea id="reason" name="message[origin]"></textarea></dd>
                <dd>
