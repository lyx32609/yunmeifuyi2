...
<div class="petition-create">
    ...
    <form action="/petition/create" id="signForm" enctype="multipart/form-data" method="post">
        ...
        <div class="cont">
            <div class="cont_tit" style="width:100%;"><h5>外出签呈</h5></div>
            <input type="hidden" name="type" value="11">
            <input name="_csrf-backend" type="hidden" id="_csrf" value="<?= Yii::$app->request->csrfToken?>">
            <dl>
                <dd><label for="title"><span>*</span>地点：</label><input id="title" type="text" name="message[site]"></dd>
                <dd><label for="origin"><span>*</span>事由：</label><textarea id="origin" name="message[origin]"></textarea></dd>
                <dd>
