...
<div class="petition-create">
    ...
    <form action="/petition/create" id="signForm" enctype="multipart/form-data" method="post">
        ...
        <div class="cont">
            <div class="cont_tit" style="width:100%;"><h5>采购签呈</h5></div>
            <input type="hidden" name="type" value="5">
            <input name="_csrf-backend" type="hidden" id="_csrf" value="<?= Yii::$app->request->csrfToken?>">
            <dl>
                <dd><label for="goods"><span>*</span>物品：</label><input id="goods" type="text" name="message[goods]"></dd>
                <dd><label for="details"><span>*</span>详情：</label><textarea id="details" name="message[details]"></textarea></dd>
