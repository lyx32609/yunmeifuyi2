...
/* @var $model backend\models\WithdrawRecordSearch */
...
<div class="withdraw-record-search">
    ...
    <div class="row">
        ...
        <div class="col-xs-6">
            <?php echo $form->field($model, 'department')->dropDownList(ArrayHelper::map(backend\models\WithdrawRecord::findDepartment()->orderBy('id asc')->all(), 'id', 'name'), ['prompt' => '请选择部门'])->label('部门'); ?>
        </div>
        <div class="col-xs-6" >
