...
/**
 * ChildCompanyCategroySearch represents the model behind the search form about `backend\models\CompanyCategroy`.
 */
class ChildCompanyCategroySearch extends CompanyCategroy
{
    /**
     * @inheritdoc
     */
